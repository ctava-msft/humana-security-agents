...
module storage 'br/public:avm/res/storage/storage-account:0.8.3' = {
  ...
  params: {
    ...
    blobServices: {
      containers: [{name: deploymentStorageContainerName}, {name: 'security-data-backups'}]
    }
...
@description('API Management service URL for accessing the security data API.')
...
@description('Security Data CosmosDB database name.')
output COSMOSDB_DATABASE_NAME string = cosmosDatabaseName

@description('Security Data CosmosDB container name.')
